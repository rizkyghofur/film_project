...
class TopratedMovieView extends GetView<TopratedMovieController> {
        ...
        () => LazyLoadScrollView(
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              int idMovie =
                  controller.topratedMovieList[index].id! + randomNumber;
              return PosterMovieWidget(
                idMovie: idMovie,
                movieData: controller.topratedMovieList[index],
              );
            },
          ),
        ),
